...
import { fetchAllFilterProductsAsync, /*fetchAllproductsAsync,*/ fetchBrandsAsync, fetchCategoriesAsync, selectAllproducts, selectBrands, selectCategories, selectTotalItems } from '../ProductListSlice'
...
export default function Products() {
    ...
    useEffect(()=>{
       dispatch(fetchAllFilterProductsAsync())
    },[dispatch])
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 ">
            <h1 className="text-3xl font-bold mt-16 tracking-tight text-gray-900">All Products</h1>

            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <MenuButton className="group shadow-nones inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900">
                    Sort
                    <ChevronDownIcon
              ...
              <button type="button" className="-m-2 outline-none ml-5 p-2 text-gray-400 hover:text-gray-500 sm:ml-7">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                {products.length>0 ? <ProductGrid products={products}></ProductGrid>: <p className='text-2xl font-semibold'>No Product Available....</p>}
              </div>
            </div>
          </section>
        ...
        <div className="mx-auto max-w-2xl px-4 sm:px-6  lg:max-w-7xl lg:px-8">
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
            {products?products.map((product) => (
              <Link to={`/product-details/${product.id}`} key={product.id} className="group relative">
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    ...
                    <p className='text-red-500'>{product.stock<=0 && "out of stock"}</p>
                  </div>
